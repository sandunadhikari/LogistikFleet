    ...
    public partial class OtherInformationPage : ContentPage
    {
        ...
        private void licimageUplaodViewer_Tapped(object sender, EventArgs e)
        {
            ...
            if (licImageFrame.IsVisible)
            {
                ...
                licImageBtn.Source = ImageSource.FromResource("LogistikFleet.Assets.iconWhiteCamera.png", assembly);
            }
            else
            {
                licImageFrame.IsVisible = true;
                licImageBtn.Source = ImageSource.FromResource("LogistikFleet.Assets.iconWhiteUp.png", assembly);
            }
        }
